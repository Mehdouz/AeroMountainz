      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <Reveal threshold={0.1}>
          <div className="mb-16 lg:mb-20">
            ...
            />
            {data.subtitle && (
              <p className="mt-4 font-serif italic text-xl lg:text-2xl text-[var(--champagne)]/85 font-light">
                {data.subtitle}
              </p>
            )}
          </div>
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-12">
          <div className="hidden lg:block absolute top-[40px] left-[16.66%] right-[16.66%] h-px bg-[var(--champagne-line)]" />

          {data.steps.map((step, i) => (
            <Reveal key={i} threshold={0.1} delay={i * 120}>
              <div className="relative z-[1] text-center">
                <span className="inline-block px-5 bg-[var(--bone)] font-serif italic font-light text-5xl lg:text-6xl text-[var(--champagne)] leading-none mb-6">
                  {step.number}
                </span>
                <h3 className="font-serif text-xl lg:text-2xl text-[var(--text-primary)] mb-3 font-normal">
                  {step.title}
                </h3>
                <div className="max-w-[280px] mx-auto text-sm text-[var(--ink-65)] leading-[1.65] font-sans [&_strong]:text-[var(--text-primary)] [&_strong]:font-medium [&_p]:m-0">
