...
export const bonCadeauFinalCtaSection = defineType({
  name: 'bonCadeauFinalCtaSection',
  title: 'Section CTA final (Bon cadeau)',
  type: 'object',
  fields: [
  ...
  preview: {
    ...
    prepare: ({ title, media }) => ({
      title: `Bon cadeau · CTA final — ${title || '(sans titre)'}`,
      media,
    }),
  },
})
