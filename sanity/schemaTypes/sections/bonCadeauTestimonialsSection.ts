...
export const bonCadeauTestimonialsSection = defineType({
  name: 'bonCadeauTestimonialsSection',
  title: 'Section Témoignages (Bon cadeau)',
  type: 'object',
  fields: [
  ...
  preview: {
    ...
    prepare: ({ title }) => ({ title: `Bon cadeau · Témoignages — ${title || ''}` }),
  },
})
