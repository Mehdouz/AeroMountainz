...
export const bonCadeauExperienceSection = defineType({
  name: 'bonCadeauExperienceSection',
  title: 'Section Expérience (Bon cadeau)',
  type: 'object',
  fields: [
  ...
  preview: {
    ...
    prepare: ({ title }) => ({ title: `Bon cadeau · Expérience — ${title || ''}` }),
  },
})
